...
gulp.task('sharp', function() {
    return gulp
        .src('./src/img/formats/**/*.{jpg,png}')
        .pipe(sharpResponsive({
            formats: [
              { format: "webp", quality: 90 },
            ],
          }))
          .pipe(gulp.dest('./build/img/formats'));
});
...
gulp.task('serve', function() {
    ...
    gulp.watch('./src/img/**/*', gulp.series('sharp'));
    gulp.watch('./src/assets/**/*', gulp.series('assets'));
});


gulp.task('build', gulp.series('clean', 'images', 'sharp', 'sprite', 'handlebars', gulp.parallel('assets', 'styles', 'scripts')));

gulp.task('build-production', gulp.series('clean', 'images','sharp', 'sprite', 'handlebars', gulp.parallel('assets', 'styles', 'scripts-production')));
